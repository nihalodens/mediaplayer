...
const VideoCard = ({displayData,setDeleteVideoResponseFromVideoCard,insideCategory}) => {
  ...
  return (
    ...
    <Modal size='lg' centered show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe width="100%" height="568" src={`${displayData?.youTubeLink}?autoplay=1`} title="Caption"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen>
        </iframe>
        </Modal.Body>
      </Modal>
    </>
